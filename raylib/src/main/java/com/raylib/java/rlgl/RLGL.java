...
import static com.raylib.java.Config.RL_DEFAULT_BATCH_BUFFER_ELEMENTS;
import static com.raylib.java.Config.RL_DEFAULT_BATCH_DRAWCALLS;
import static com.raylib.java.Config.RL_DEFAULT_BATCH_MAX_TEXTURE_UNITS;
...
import static com.raylib.java.Config.SUPPORT_GL_DETAILS_INFO;
...
import static com.raylib.java.rlgl.RLGL.rlGlVersion.OPENGL_11;
import static com.raylib.java.rlgl.RLGL.rlGlVersion.OPENGL_21;
import static com.raylib.java.rlgl.RLGL.rlGlVersion.OPENGL_33;
...
import static org.lwjgl.opengl.GL15.GL_CLAMP_TO_EDGE;
import static org.lwjgl.opengl.GL15.GL_COMPRESSED_TEXTURE_FORMATS;
import static org.lwjgl.opengl.GL15.GL_DEPTH_COMPONENT16;
import static org.lwjgl.opengl.GL15.GL_DYNAMIC_DRAW;
import static org.lwjgl.opengl.GL15.GL_ELEMENT_ARRAY_BUFFER;
import static org.lwjgl.opengl.GL15.GL_FUNC_ADD;
import static org.lwjgl.opengl.GL15.GL_FUNC_SUBTRACT;
import static org.lwjgl.opengl.GL15.GL_MAX_CUBE_MAP_TEXTURE_SIZE;
import static org.lwjgl.opengl.GL15.GL_NUM_COMPRESSED_TEXTURE_FORMATS;
import static org.lwjgl.opengl.GL15.GL_READ_ONLY;
import static org.lwjgl.opengl.GL15.GL_READ_WRITE;
import static org.lwjgl.opengl.GL15.GL_STATIC_DRAW;
import static org.lwjgl.opengl.GL15.GL_TEXTURE0;
import static org.lwjgl.opengl.GL15.GL_TEXTURE_CUBE_MAP;
import static org.lwjgl.opengl.GL15.GL_TEXTURE_CUBE_MAP_POSITIVE_X;
import static org.lwjgl.opengl.GL15.GL_TEXTURE_WRAP_R;
import static org.lwjgl.opengl.GL15.glActiveTexture;
import static org.lwjgl.opengl.GL15.glBindBuffer;
import static org.lwjgl.opengl.GL15.glBlendEquation;
import static org.lwjgl.opengl.GL15.glBufferData;
import static org.lwjgl.opengl.GL15.glBufferSubData;
import static org.lwjgl.opengl.GL15.glCompressedTexImage2D;
...
import static org.lwjgl.opengl.GL20.glVertexAttrib1fv;
import static org.lwjgl.opengl.GL20.glVertexAttrib2fv;
import static org.lwjgl.opengl.GL20.glVertexAttrib3fv;
...
import static org.lwjgl.opengl.GL43.glGetInteger64;
...
public class RLGL {
    ...
    public static String rlGetPixelFormatName(int format) {
        switch (format) {
            case RL_PIXELFORMAT_UNCOMPRESSED_GRAYSCALE:
                return "GRAYSCALE";          // 8 bit per pixel (no alpha)
            case RL_PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA:
                return "GRAY_ALPHA";        // 8*2 bpp (2 channels)
            case RL_PIXELFORMAT_UNCOMPRESSED_R5G6B5:
            ...
            case RL_PIXELFORMAT_COMPRESSED_DXT1_RGB:
                return "DXT1_RGB";              // 4 bpp (no alpha)
            case RL_PIXELFORMAT_COMPRESSED_DXT1_RGBA:
                return "DXT1_RGBA";            // 4 bpp (1 bit alpha)
            case RL_PIXELFORMAT_COMPRESSED_DXT3_RGBA:
                return "DXT3_RGBA";            // 8 bpp
            case RL_PIXELFORMAT_COMPRESSED_DXT5_RGBA:
                return "DXT5_RGBA";            // 8 bpp
            case RL_PIXELFORMAT_COMPRESSED_ETC1_RGB:
                return "ETC1_RGB";              // 4 bpp
            case RL_PIXELFORMAT_COMPRESSED_ETC2_RGB:
                return "ETC2_RGB";              // 4 bpp
            case RL_PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA:
                return "ETC2_RGBA";        // 8 bpp
            case RL_PIXELFORMAT_COMPRESSED_PVRT_RGB:
                return "PVRT_RGB";              // 4 bpp
            case RL_PIXELFORMAT_COMPRESSED_PVRT_RGBA:
                return "PVRT_RGBA";            // 4 bpp
            case RL_PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA:
                return "ASTC_4x4_RGBA";    // 8 bpp
            case RL_PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA:
                return "ASTC_8x8_RGBA";    // 2 bpp
            default:
                return "UNKNOWN";
        }
    }
    ...
    static byte[] rlGenNextMipmapData(byte[] srcData, int srcWidth, int srcHeight) {
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int x = 0; x < width; x++) {
                ...
                prow[0] = (byte) ((srcData[(y2 * srcWidth + x2) * 4] + srcData[(y2 * srcWidth + x2 + 1) * 4]) / 2);
                ...
                pcol[0] = (byte) ((srcData[((y2 + 1) * srcWidth + x2) * 4] + srcData[((y2 + 1) * srcWidth + x2 + 1) * 4]) / 2);
                ...
                mipmap[(y * width + x) * 4] = (byte) ((prow[0] + pcol[0]) / 2);
