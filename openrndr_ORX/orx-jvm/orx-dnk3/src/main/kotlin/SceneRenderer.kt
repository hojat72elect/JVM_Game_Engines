...
class SceneRenderer {
        ...
        run {
            ...
            for (pass in outputPasses) {
                val materialContext = MaterialContext(
                    pass, context.lights, context.fogs, shadowLightTargets, meshCubemaps, irradianceSH?.probeCount
                        ?: 0
                )
    ...
    internal fun drawPass(
        drawer: Drawer, pass: RenderPass, materialContext: MaterialContext,
            ...
            .forEach {
                ...
                drawer.isolated {
                    ...
                    drawer.vertexBufferInstances(
                        primitive.primitive.geometry.vertexBuffers,
