...
abstract class ColorBufferFacetCombiner(
    facets: Set<FacetType>,
    targetOutput: String,
    val format: ColorFormat,
    val type: ColorType,
    val blendMode: BlendMode = BlendMode.BLEND
) : FacetCombiner(facets, targetOutput) {
...
class DiffuseSpecularFacet : ColorBufferFacetCombiner(
    setOf(FacetType.DIFFUSE, FacetType.SPECULAR),
...
class DiffuseSpecularAlphaFacet : ColorBufferFacetCombiner(
    setOf(FacetType.DIFFUSE, FacetType.SPECULAR),
    "diffuseSpecular", ColorFormat.RGB, ColorType.FLOAT16
) {
    override fun generateShader(): String =
...
class AmbientOcclusionFacet : ColorBufferFacetCombiner(
    setOf(FacetType.AMBIENT, FacetType.OCCLUSION),
...
class MaterialFacet : ColorBufferFacetCombiner(
    setOf(FacetType.DIFFUSE),
...
class SpecularFacet : ColorBufferFacetCombiner(
    setOf(FacetType.SPECULAR),
    "diffuseSpecular", ColorFormat.RGB, ColorType.FLOAT16
) {
    override fun generateShader(): String =
...
class EmissiveFacet : ColorBufferFacetCombiner(
    setOf(FacetType.EMISSIVE),
...
class EmissiveAlphaFacet : ColorBufferFacetCombiner(
    setOf(FacetType.EMISSIVE),
