...
) : TextureFromColorBuffer(texture, textureFunction) {
    override fun toString(): String {
...
class PBRMaterial : Material {
    ...
    """.trimIndent() else ""
            ...
            shadeStyle {
                ...
                ${
                            genGlslGatherSH(
                                materialContext.irradianceSH!!.xCount, materialContext.irradianceSH!!.yCount,
                    ...
                    is SpotLight -> {
                        ...
                        if (light.shadows is Shadows.MappedShadows) {
                            context.shadowMaps[light]?.let {
                                ...
                                shadeStyle.parameter(
                                    "lightTransform$index",
