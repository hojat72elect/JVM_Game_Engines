...
internal class Downscale(filterUrl: String = "/shaders/gl3/poisson/downscale.frag") : Filter(filterShaderFromUrl(resourceUrl(filterUrl))) {
...
internal class Upscale(filterUrl: String = "/shaders/gl3/poisson/upscale.frag") : Filter(filterShaderFromUrl(resourceUrl(filterUrl))) {
    var h1: FloatArray by parameters
...
internal class Convolution(filterUrl: String = "/shaders/gl3/poisson/filter.frag") : Filter(filterShaderFromUrl(resourceUrl(filterUrl))) {
    var g: FloatArray by parameters
...
internal class ConvolutionPyramid(
