...
public class LensFlare {
    ...
    private final List<LensFlareTexturePanel> lensFlareTexturePanels = new ArrayList<LensFlareTexturePanel>();
    private final Vec2f windowMidPos = new Vec2f(BaseContext.getConfig().getFrameWidth() / 2f, BaseContext.getConfig().getFrameHeight() / 2f);
