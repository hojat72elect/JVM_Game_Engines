...
public class SunLightScattering {
    ...
    @Getter
    private final GLTexture sunLightScatteringSceneTexture;
    @Getter
    private final GLTexture sunLightScatteringTexture;
    private final SunLightScatteringShader lightScatteringShader;
    private final SunLightScatteringAdditiveBlendShader additiveBlendShader;
