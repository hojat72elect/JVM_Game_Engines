...
public class GLTerrainConfig extends QuadtreeConfig {
    ...
    public GLTerrainConfig() {
        ...
        for (int i = 0; i < fractalCount; i++) {
            ...
            boolean choppy = Integer.valueOf(properties.getProperty("fractal" + i + ".choppy")) == 1;
    ...
    public class FractalMapGenerator {
        ...
        @Getter
        private final GLTexture heightmap;

        @Getter
        private final GLTexture normalmap;

        private final FractalMapShader shader;
        private final int N;
        private final boolean edgeElevation;
    ...
    public class SplatMapGenerator {
        ...
        @Getter
        private final GLTexture splatmap;
        private final SplatMapShader shader;
        private final int N;
