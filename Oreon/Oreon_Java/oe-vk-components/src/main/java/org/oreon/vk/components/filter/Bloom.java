...
public class Bloom {
    ...
    private final VkPipeline sceneBrightnessPipeline;
    private final DescriptorSet sceneBrightnessDescriptorSet;
    private final DescriptorSetLayout sceneBrightnessDescriptorSetLayout;
    private final List<DescriptorSet> sceneBrightnessDescriptorSets;
    // horizontal blur resources
    private final DescriptorSetLayout horizontalBlurDescriptorSetLayout;
    private final List<DescriptorSet> horizontalBlurDescriptorSets;
    private final VkPipeline horizontalBlurPipeline;
    private final DescriptorSet horizontalBlurDescriptorSet;
    // vertical blur resources
    private final VkPipeline verticalBlurPipeline;
    private final DescriptorSet verticalBlurDescriptorSet;
    private final DescriptorSetLayout verticalBlurDescriptorSetLayout;
    private final List<DescriptorSet> verticalBlurDescriptorSets;
    // blend resources
    private final VkPipeline blendPipeline;
    private final DescriptorSet blendDescriptorSet;
    private final DescriptorSetLayout blendDescriptorSetLayout;
    private final VkSampler bloomBlurSampler_div2;
    private final VkSampler bloomBlurSampler_div4;
    private final VkSampler bloomBlurSampler_div8;
    private final VkSampler bloomBlurSampler_div16;
    private final List<DescriptorSet> blendDescriptorSets;
    // final bloom Scene resources
    private final VkPipeline bloomScenePipeline;
    private final DescriptorSet bloomSceneDescriptorSet;
    private final DescriptorSetLayout bloomSceneDescriptorSetLayout;
    private final List<DescriptorSet> bloomSceneDescriptorSets;
    private final ByteBuffer pushConstants;
    private final ByteBuffer pushConstants_blend;
